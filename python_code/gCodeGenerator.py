...
image_frame = Frame(tab1, width=700, height=900, relief="flat")
...
all_contour_settings_frame = Frame(tab1, width=400, height=800)
...
newimage_frame = Frame(all_contour_settings_frame, width=600, height=40, highlightbackground="black", highlightthickness=1, pady=5, padx=10)
...
separate_window_frame = Frame(all_contour_settings_frame, width=400, height=40, highlightbackground="black", highlightthickness=1, pady=5)
...
printing_settings_frame = Frame(tab2, width=500, height=700, padx=20, pady=20, highlightthickness=0, highlightbackground="black")
...
printing_area_frame = Frame(printing_settings_frame, width=450, height=450, highlightbackground="black", highlightthickness=1)
...
spacing_frame = Frame(printing_settings_frame, width=320, height=10)
